...
<div class="container">
    ...
    <div class="card-body">
        <form action="{{url('/formpengadaan/update/[$pengadaan->id_pengadaan]')}}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="form-group row">
                <label class="col-sm-12 col-md-2 col-form-label">Id pengadaan</label>
                <div class="col-sm-12 col-md-10">
                    <input class="form-control" type="Text" name="id_pengadaan" value="{{$pengadaan->id_pengadaan}}">
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-md-10">
                    <input class="form-control" type="date" name="tanggal_pengadaan" value="{{$pengadaan->tanggal_pengadaan}}">
                </div>
            </div>
            <div class="form-group row">
                <label class="col-sm-12 col-md-2 col-form-label">Jumlah Pengadaan</label>
                <div class="col-sm-12 col-md-10">
                    <input class="form-control date-picker" type="text" name="jumlah_pengadaan" value="{{$pengadaan->jumlah_pengadaan}}">
                </div>
            </div>
            <div class="form-group row">
                <label class="col-sm-12 col-md-2 col-form-label">Harga Pengadaan</label>
                <div class="col-sm-12 col-md-10">
                    <input class="form-control" type="number" name="harga_pengadaan" value="{{$pengadaan->harga_pengadaan}}">
                </div>
            </div>
            <div class="form-group row">
